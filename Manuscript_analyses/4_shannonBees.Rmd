...
ps0 <- glmer(shan0 ~ 1 + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps1 <- glmer(shan0 ~ nestTYPE + nBehavs + caste + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps2 <- glmer(shan0 ~ nestTYPE + nBehavs + caste + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps3 <- glmer(shan0 ~ nestTYPE + caste + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps4 <- glmer(shan0 ~ nestTYPE + nBehavs + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps5 <- glmer(shan0 ~ nBehavs + caste + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps6 <- glmer(shan0 ~ nestTYPE + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps7 <- glmer(shan0 ~ nBehavs + (1|nestID),
              data = dol, family = binomial(link = "logit"))
ps8 <- glmer(shan0 ~ caste + (1|nestID),
              data = dol, family = binomial(link = "logit"))
...
# model 0 vs. >0 shannon values
# need to add natal colony as random effect
ps0 <- glmer(shan1 ~ 1 + (1|nestID) + (1|caste),
              data = dol)
ps1 <- glmer(shan1 ~ nestTYPE + nBehavs + caste + (1|nestID),
              data = dol)
ps2 <- glmer(shan1 ~ nestTYPE + nBehavs + (1|nestID),
              data = dol)
ps3 <- glmer(shan1 ~ nestTYPE + caste + (1|nestID),
              data = dol)
ps4 <- glmer(shan1 ~ nestTYPE + nBehavs + (1|nestID),
              data = dol)
ps5 <- glmer(shan1 ~ nBehavs + caste + (1|nestID),
              data = dol)
ps6 <- glmer(shan1 ~ nestTYPE + (1|nestID),
              data = dol)
ps7 <- glmer(shan1 ~ nBehavs + (1|nestID),
              data = dol)
ps8 <- glmer(shan1 ~ caste + (1|nestID),
              data = dol)
...
# need to add natal colony as random effect
ts <- glmer(shannon ~ timepoint + nBehavs + nestTYPE + caste + (1|nestID),
              data = dolT)
mymodel <- ts
summary(mymodel)
tab_model(mymodel)
