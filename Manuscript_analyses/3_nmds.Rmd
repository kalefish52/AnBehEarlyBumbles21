...
shancounts<-specialgroups %>% dplyr::select(nestID, specBehav) %>% filter(specBehav != "NA") %>% mutate(count=1) %>% group_by(nestID, specBehav) %>% 
...
ggarrange(G1, G2, G3, G4, nrow = 2, ncol=2, common.legend = TRUE, legend="bottom")
