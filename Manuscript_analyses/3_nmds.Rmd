...
nmds_time<-read.csv("../Data/filtData/count_time.csv") %>% 
  select(nestID, nestTYPE, beeID, caste,  
...
# Plot it using ggplot
ggplot() + 
  geom_point(data=nmds_data, aes(x=NMDS1, y=NMDS2, shape = cluster, color = specBehav), size = 2, position = position_jitter(width=0.05, height=0.05), alpha = 0.7) + 
