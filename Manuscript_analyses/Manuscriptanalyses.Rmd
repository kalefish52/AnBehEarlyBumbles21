...
ggplot() + geom_text(data=behav.scores.NT, aes(x=NMDS1, y=NMDS2, label=behav)) +
  ...
  coord_cartesian(xlim=c(-1, 2)) + geom_jitter(width=0.1, height=0.1) + ggtitle("NT")
...
ggplot() + geom_text(data=behav.scores.NF, aes(x=NMDS1, y=NMDS2, label=behav)) +
  ...
  coord_cartesian(xlim=c(-1, 2)) + geom_jitter(width=0.1, height=0.1) +ggtitle("NF")
...
ggplot() + geom_text(data=behav.scores.QT, aes(x=NMDS1, y=NMDS2, label=behav)) +
  ...
  coord_cartesian(xlim=c(-1, 2)) + geom_jitter(width=0.1, height=0.1) +ggtitle("QT")
...
ggplot() + geom_text(data=behav.scores.QF, aes(x=NMDS1, y=NMDS2, label=behav)) +
  ...
  coord_cartesian(xlim=c(-2, 2)) + geom_jitter(width=0.1, height=0.1) + ggtitle("QF")
