...
ps0 <- glmer(shannon ~1 + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps1 <- glmer(shannon ~ behav*nestTYPE + nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps9 <- glmer(shannon ~ behav + nestTYPE + nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps2 <- glmer(shannon ~ behav + nestTYPE + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps3 <- glmer(shannon ~ behav + nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps4 <- glmer(shannon ~ nestTYPE + nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps5 <- glmer(shannon ~ behav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps6 <- glmer(shannon ~ nestTYPE + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps7 <- glmer(shannon ~ nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
ps8 <- glmer(shannon ~ behav*nestTYPE + nBehav + (1|nestTYPE:nestID) + (1|natal),
              data = taskShan)
model.sel(ps0, ps1, ps2, ps3, ps4, ps5, ps6, ps7, ps8, ps9)
