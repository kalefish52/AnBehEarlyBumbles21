...
```
```{r}
## run k means analysis seed set i don't really understand....
## count_data[,3:5] selects the counts of each behavior (ie. 3d plot in space)
## 3 means we're forcing 3 clusters. *******need to figure out how to test for number of clusters********
set.seed(20)
test <- kmeans(count_data[, 3:5], 3, nstart = 20)
test
