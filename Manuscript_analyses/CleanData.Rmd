...
egglaying<-read.csv("./Egg_laying_Events.csv", header=TRUE) %>% select(MicrocolonyID, Date.Eggs.Laid, WorkerID, Caste, Time, assigned.To) %>% drop_na %>% 
...
write.csv(allBehavs, "count_stats.csv")
```
