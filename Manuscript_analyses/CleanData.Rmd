...
head(obs_data)
obs_data
write.csv(obs_data, "../Data/obs_data")
clean_obs <- nrow(obs_data)
clean_videos <- nrow(videos_data)
...
countsDATA <- counts_final %>%
  dplyr::select(nestID, nestTYPE, beeID, caste, timepoint, feedsbrood, nectarforaging, pollenforaging, egglaying, nBehavs)
