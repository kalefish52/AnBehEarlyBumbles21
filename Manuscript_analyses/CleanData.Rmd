...
nestDEV <- nestDEV %>% select(behav, nestID, nestTYPE, beeID, timeID)
...
dates_data$joinc<-paste(dates_data$timeID, dates_data$nestID, sep="_")
nestDEV$joinc<-paste(nestDEV$timeID, nestDEV$nestID, sep="_")
counts_time<-right_join(dates_data, nestDEV, by="joinc")
head(counts_time)
counts_time <- counts_time %>% select(timeID.x, nestID.x, timepoint, nestTYPE, beeID)
counts_time
