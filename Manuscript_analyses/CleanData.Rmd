...
#setwd("/Users/kaleighfisher/Desktop/Boris_files")
#filenames <- list.files("/Users/kaleighfisher/Desktop/Boris_files", pattern="*.csv")
#read.csv("NF02.csv")

## loop over the files and import all of them. rename column names to remove "." and make shorter
#borisfiles <- lapply(filenames, read.csv, header = TRUE, col.names = c("obsID", "obsDate", "filename", "totalLen", "fps", "beeID", "behav", "mod", "behavType", "start", "stop", "dur", "comStart", "comStop"))
