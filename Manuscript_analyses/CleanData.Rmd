...
# Clean Data
split obsID column from BORIS obs_data into its component parts to enable manipulation by camera/colony/time/date
```{r}
...
obs_data[startsWith(obs_data$obsID, " for"), 1]
...
for (i in 1:nrow(obs_data)) {             # for every row in the dataframe
  if (obs_data$camID[i] == "nest") {      # if it's a nest video
