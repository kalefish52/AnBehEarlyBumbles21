...
videos_data$nestID <- as.character(videos_data$nestID)
...
obs_data <- obs_data[!obs_data$obsID == "QF01",]
videos_data <- videos_data[!videos_data$obsID == "QF01",]
...
print(paste(NectPollRemov_obs - fiveMinRemov_obs, "nest observations were removed because they started after the five minute mark.", sep = " "))
