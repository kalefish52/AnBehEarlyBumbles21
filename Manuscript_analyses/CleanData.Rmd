...
# Add time (early/late) to count_data
```{r}
...
## add column to fill with sum of counts for each behav
counts_time$totCount <- rowSums(count_data[5:ncol(count_data)], na.rm = TRUE)
...
# Add egg laying events to count_data and make a new csv file - count_stats.csv
