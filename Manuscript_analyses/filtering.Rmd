...
print(paste(length(rmNests), "nests need to be removed from the data because they have fewer than 3 instances of brood feeding or foraging recorded"))
rmNests
...
print(paste(length(rmNestsEarly), "nests need to be removed from the data because they have fewer than 3 instances of brood feeding or foraging recorded"))
rmNestsEarly
...
print(paste(length(rmNestsLate), "nests need to be removed from the data because they have fewer than 3 instances of brood feeding or foraging recorded"))
rmNestsLate
