...
```{r}
ggplot(data = count_data, aes(size, specBehav, color = shannon, shape = caste)) +
...
ggplot(data = count_data, aes(avgStage, specBehav, color = shannon)) +
  geom_point(position = position_jitter(width=0.1, height=0.2), alpha = 0.8) +
  stat_summary(fun = mean, geom = "point", size = 5) +
  scale_color_gradient(low="dark blue", high="yellow") +
  # scale_color_manual(values = c("#F8766D", "#7CAE00", "#00BFC4", "#8c8c8c", "#ffc425")) +
...
ggplot(data = count_data, aes(avgRes, specBehav, color = shannon)) +
  geom_point(position = position_jitter(width=0.1, height=0.2), alpha = 0.8) +
  stat_summary(fun = mean, geom = "point", size = 5) +
  scale_color_gradient(low="dark blue", high="yellow") +
  # scale_color_manual(values = c("#F8766D", "#7CAE00", "#00BFC4", "#8c8c8c", "#ffc425")) +
...
count_wide <- pivot_wider(count_data, id_cols = c(caste, nestTYPE, beeID, nestID, size, avgStage, avgRes, natal, queen, nWork), names_from = specBehav, values_from = specBehav)
...
el1 <- glmer(egglaying ~ size + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el2 <- glmer(egglaying ~ size + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el3 <- glmer(egglaying ~ size + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el4 <- glmer(egglaying ~ size + avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el5 <- glmer(egglaying ~ size + avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el6 <- glmer(egglaying ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el7 <- glmer(egglaying ~ size + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el8 <- glmer(egglaying ~ size + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el9 <- glmer(egglaying ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el10 <- glmer(egglaying ~ avgStage + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el11 <- glmer(egglaying ~ avgStage + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
el14 <- glmer(egglaying ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el15 <- glmer(egglaying ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el16 <- glmer(egglaying ~ size + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el17 <- glmer(egglaying ~ size  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el18 <- glmer(egglaying ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el19 <- glmer(egglaying ~ avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el20 <- glmer(egglaying ~ avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el21 <- glmer(egglaying ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el22 <- glmer(egglaying ~ avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el23 <- glmer(egglaying ~ avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
el26 <- glmer(egglaying ~ avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el27 <- glmer(egglaying ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el28 <- glmer(egglaying ~ queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el29 <- glmer(egglaying ~ nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
fb0 <- glmer(feedsbrood ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
fb1 <- glmer(feedsbrood ~ size + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb2 <- glmer(feedsbrood ~ size + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb3 <- glmer(feedsbrood ~ size + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb4 <- glmer(feedsbrood ~ size + avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb5 <- glmer(feedsbrood ~ size + avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb6 <- glmer(feedsbrood ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb7 <- glmer(feedsbrood ~ size + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb8 <- glmer(feedsbrood ~ size + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb9 <- glmer(feedsbrood ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb10 <- glmer(feedsbrood ~ avgStage + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb11 <- glmer(feedsbrood ~ avgStage + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
fb14 <- glmer(feedsbrood ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb15 <- glmer(feedsbrood ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb16 <- glmer(feedsbrood ~ size + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb17 <- glmer(feedsbrood ~ size  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb18 <- glmer(feedsbrood ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb19 <- glmer(feedsbrood ~ avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb20 <- glmer(feedsbrood ~ avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb21 <- glmer(feedsbrood ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb22 <- glmer(feedsbrood ~ avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb23 <- glmer(feedsbrood ~ avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
fb26 <- glmer(feedsbrood ~ avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb27 <- glmer(feedsbrood ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb28 <- glmer(feedsbrood ~ queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb29 <- glmer(feedsbrood ~ nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
nf0 <- glmer(nectarforaging ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
nf1 <- glmer(nectarforaging ~ size + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf2 <- glmer(nectarforaging ~ size + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf3 <- glmer(nectarforaging ~ size + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf4 <- glmer(nectarforaging ~ size + avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf5 <- glmer(nectarforaging ~ size + avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf6 <- glmer(nectarforaging ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf7 <- glmer(nectarforaging ~ size + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf8 <- glmer(nectarforaging ~ size + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf9 <- glmer(nectarforaging ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf10 <- glmer(nectarforaging ~ avgStage + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf11 <- glmer(nectarforaging ~ avgStage + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
nf14 <- glmer(nectarforaging ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf15 <- glmer(nectarforaging ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf16 <- glmer(nectarforaging ~ size + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf17 <- glmer(nectarforaging ~ size  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf18 <- glmer(nectarforaging ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf19 <- glmer(nectarforaging ~ avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf20 <- glmer(nectarforaging ~ avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf21 <- glmer(nectarforaging ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf22 <- glmer(nectarforaging ~ avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf23 <- glmer(nectarforaging ~ avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
nf26 <- glmer(nectarforaging ~ avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf27 <- glmer(nectarforaging ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf28 <- glmer(nectarforaging ~ queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf29 <- glmer(nectarforaging ~ nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
gen0 <- glmer(generalist ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
gen1 <- glmer(generalist ~ size + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen2 <- glmer(generalist ~ size + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen3 <- glmer(generalist ~ size + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen4 <- glmer(generalist ~ size + avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen5 <- glmer(generalist ~ size + avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen6 <- glmer(generalist ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen7 <- glmer(generalist ~ size + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen8 <- glmer(generalist ~ size + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen9 <- glmer(generalist ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen10 <- glmer(generalist ~ avgStage + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen11 <- glmer(generalist ~ avgStage + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
gen14 <- glmer(generalist ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen15 <- glmer(generalist ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen16 <- glmer(generalist ~ size + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen17 <- glmer(generalist ~ size  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen18 <- glmer(generalist ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen19 <- glmer(generalist ~ avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen20 <- glmer(generalist ~ avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen21 <- glmer(generalist ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen22 <- glmer(generalist ~ avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen23 <- glmer(generalist ~ avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
gen26 <- glmer(generalist ~ avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen27 <- glmer(generalist ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen28 <- glmer(generalist ~ queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen29 <- glmer(generalist ~ nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
laz0 <- glmer(lazy ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
laz1 <- glmer(lazy ~ size + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz2 <- glmer(lazy ~ size + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz3 <- glmer(lazy ~ size + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz4 <- glmer(lazy ~ size + avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz5 <- glmer(lazy ~ size + avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz6 <- glmer(lazy ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz7 <- glmer(lazy ~ size + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz8 <- glmer(lazy ~ size + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz9 <- glmer(lazy ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz10 <- glmer(lazy ~ avgStage + avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz11 <- glmer(lazy ~ avgStage + avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
laz14 <- glmer(lazy ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz15 <- glmer(lazy ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz16 <- glmer(lazy ~ size + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz17 <- glmer(lazy ~ size  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz18 <- glmer(lazy ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz19 <- glmer(lazy ~ avgStage + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz20 <- glmer(lazy ~ avgStage  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz21 <- glmer(lazy ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz22 <- glmer(lazy ~ avgRes + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz23 <- glmer(lazy ~ avgRes  + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
laz26 <- glmer(lazy ~ avgRes + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz27 <- glmer(lazy ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz28 <- glmer(lazy ~ queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
laz29 <- glmer(lazy ~ nWork + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
s0 <- glmer(size ~ 1 + (1|natal) + (1|nestID),
              data = count_data)
s1 <- glmer(size ~ specBehav + avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s3 <- glmer(size ~ specBehav + avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_data)
s4 <- glmer(size ~ specBehav + avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s5 <- glmer(size ~ specBehav + avgStage + queen + (1|nestID) + (1|natal),
              data = count_data)
s6 <- glmer(size ~ specBehav + avgStage + nWork + (1|nestID) + (1|natal),
              data = count_data)
s7 <- glmer(size ~ specBehav + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s8 <- glmer(size ~ specBehav + avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s9 <- glmer(size ~ specBehav + avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
s10 <- glmer(size ~ avgStage + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s11 <- glmer(size ~ avgStage + avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s12 <- glmer(size ~ avgStage + avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s15 <- glmer(size ~ avgStage + avgRes + (1|nestID) + (1|natal),
              data = count_data)
s16 <- glmer(size ~ specBehav + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s17 <- glmer(size ~ specBehav + queen + (1|nestID) + (1|natal),
              data = count_data)
s18 <- glmer(size ~ specBehav + nWork + (1|nestID) + (1|natal),
              data = count_data)
s19 <- glmer(size ~ avgStage + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s20 <- glmer(size ~ avgStage + queen + (1|nestID) + (1|natal),
              data = count_data)
s21 <- glmer(size ~ avgStage + nWork + (1|nestID) + (1|natal),
              data = count_data)
s22 <- glmer(size ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s23 <- glmer(size ~ avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s24 <- glmer(size ~ avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s27 <- glmer(size ~ avgRes + (1|nestID) + (1|natal),
              data = count_data)
s28 <- glmer(size ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s29 <- glmer(size ~ queen + (1|nestID) + (1|natal),
              data = count_data)
s30 <- glmer(size ~ nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s0 <- glmer(avgStage ~ 1 + (1|natal) + (1|nestID),
              data = count_data)
s1 <- glmer(avgStage ~ specBehav + size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s2 <- glmer(avgStage ~ specBehav + size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s3 <- glmer(avgStage ~ specBehav + size + avgRes + (1|nestID) + (1|natal),
              data = count_data)
s4 <- glmer(avgStage ~ specBehav + size + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s5 <- glmer(avgStage ~ specBehav + size + queen + (1|nestID) + (1|natal),
              data = count_data)
s6 <- glmer(avgStage ~ specBehav + size + nWork + (1|nestID) + (1|natal),
              data = count_data)
s7 <- glmer(avgStage ~ specBehav + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s8 <- glmer(avgStage ~ specBehav + avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s9 <- glmer(avgStage ~ specBehav + avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
s10 <- glmer(avgStage ~ size + avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s11 <- glmer(avgStage ~ size + avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s12 <- glmer(avgStage ~ size + avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s15 <- glmer(avgStage ~ size + avgRes + (1|nestID) + (1|natal),
              data = count_data)
s16 <- glmer(avgStage ~ specBehav + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s17 <- glmer(avgStage ~ specBehav + queen + (1|nestID) + (1|natal),
              data = count_data)
s18 <- glmer(avgStage ~ specBehav + nWork + (1|nestID) + (1|natal),
              data = count_data)
s19 <- glmer(avgStage ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s20 <- glmer(avgStage ~ size + queen + (1|nestID) + (1|natal),
              data = count_data)
s21 <- glmer(avgStage ~ size + nWork + (1|nestID) + (1|natal),
              data = count_data)
s22 <- glmer(avgStage ~ avgRes + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s23 <- glmer(avgStage ~ avgRes + queen + (1|nestID) + (1|natal),
              data = count_data)
s24 <- glmer(avgStage ~ avgRes + nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s27 <- glmer(avgStage ~ avgRes + (1|nestID) + (1|natal),
              data = count_data)
s28 <- glmer(avgStage ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s29 <- glmer(avgStage ~ queen + (1|nestID) + (1|natal),
              data = count_data)
s30 <- glmer(avgStage ~ nWork + (1|nestID) + (1|natal),
              data = count_data)
model.sel(s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30)
...
s0 <- glmer(avgRes ~ 1 + (1|natal) + (1|nestID),
              data = count_data)
s1 <- glmer(avgRes ~ specBehav + size + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s2 <- glmer(avgRes ~ specBehav + size + queen + (1|nestID) + (1|natal),
              data = count_data)
s3 <- glmer(avgRes ~ specBehav + size + nWork + (1|nestID) + (1|natal),
              data = count_data)
s4 <- glmer(avgRes ~ specBehav + size + (1|nestID) + (1|natal),
              data = count_data)
s5 <- glmer(avgRes ~ specBehav + size + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s6 <- glmer(avgRes ~ specBehav + size + queen + (1|nestID) + (1|natal),
              data = count_data)
s7 <- glmer(avgRes ~ specBehav + size + nWork + (1|nestID) + (1|natal),
              data = count_data)
s8 <- glmer(avgRes ~ specBehav + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s9 <- glmer(avgRes ~ specBehav + queen + (1|nestID) + (1|natal),
              data = count_data)
s10 <- glmer(avgRes ~ specBehav + nWork + (1|nestID) + (1|natal),
              data = count_data)
...
s14 <- glmer(avgRes ~ size + (1|nestID) + (1|natal),
              data = count_data)
s15 <- glmer(avgRes ~ specBehav + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s16 <- glmer(avgRes ~ specBehav + queen + (1|nestID) + (1|natal),
              data = count_data)
s17 <- glmer(avgRes ~ specBehav + nWork + (1|nestID) + (1|natal),
              data = count_data)
s18 <- glmer(avgRes ~ size + queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s19 <- glmer(avgRes ~ size + queen + (1|nestID) + (1|natal),
              data = count_data)
s20 <- glmer(avgRes ~ size + nWork + (1|nestID) + (1|natal),
              data = count_data)
s21 <- glmer(avgRes ~ queen + nWork + (1|nestID) + (1|natal),
              data = count_data)
s22 <- glmer(avgRes ~ queen + (1|nestID) + (1|natal),
              data = count_data)
s23 <- glmer(avgRes ~ nWork + (1|nestID) + (1|natal),
              data = count_data)
