...
count_data %>% dplyr::select(nestID) %>% unique() %>% nrow()
...
el1 <- glmer(egglaying ~ size + ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el2 <- glmer(egglaying ~ size + ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el3 <- glmer(egglaying ~ size + ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el4 <- glmer(egglaying ~ size + ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el5 <- glmer(egglaying ~ size + ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el6 <- glmer(egglaying ~ size + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el7 <- glmer(egglaying ~ size + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el8 <- glmer(egglaying ~ size + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el9 <- glmer(egglaying ~ ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el10 <- glmer(egglaying ~ ovSavg + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el11 <- glmer(egglaying ~ ovSavg + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el12 <- glmer(egglaying ~ size + ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el13 <- glmer(egglaying ~ size + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el14 <- glmer(egglaying ~ ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
el17 <- glmer(egglaying ~ size  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el18 <- glmer(egglaying ~ ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el19 <- glmer(egglaying ~ ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el20 <- glmer(egglaying ~ ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el21 <- glmer(egglaying ~ ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el22 <- glmer(egglaying ~ ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el23 <- glmer(egglaying ~ ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el24 <- glmer(egglaying ~ size + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el25 <- glmer(egglaying ~ ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
el26 <- glmer(egglaying ~ ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
fb0 <- glmer(feedsbrood ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
fb1 <- glmer(feedsbrood ~ size + ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb2 <- glmer(feedsbrood ~ size + ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb3 <- glmer(feedsbrood ~ size + ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb4 <- glmer(feedsbrood ~ size + ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb5 <- glmer(feedsbrood ~ size + ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb6 <- glmer(feedsbrood ~ size + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb7 <- glmer(feedsbrood ~ size + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb8 <- glmer(feedsbrood ~ size + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb9 <- glmer(feedsbrood ~ ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb10 <- glmer(feedsbrood ~ ovSavg + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb11 <- glmer(feedsbrood ~ ovSavg + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb12 <- glmer(feedsbrood ~ size + ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb13 <- glmer(feedsbrood ~ size + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb14 <- glmer(feedsbrood ~ ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
fb17 <- glmer(feedsbrood ~ size  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb18 <- glmer(feedsbrood ~ ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb19 <- glmer(feedsbrood ~ ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb20 <- glmer(feedsbrood ~ ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb21 <- glmer(feedsbrood ~ ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb22 <- glmer(feedsbrood ~ ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb23 <- glmer(feedsbrood ~ ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb24 <- glmer(feedsbrood ~ size + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb25 <- glmer(feedsbrood ~ ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
fb26 <- glmer(feedsbrood ~ ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
nf0 <- glmer(nectarforaging ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
nf1 <- glmer(nectarforaging ~ size + ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf2 <- glmer(nectarforaging ~ size + ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf3 <- glmer(nectarforaging ~ size + ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf4 <- glmer(nectarforaging ~ size + ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf5 <- glmer(nectarforaging ~ size + ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf6 <- glmer(nectarforaging ~ size + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf7 <- glmer(nectarforaging ~ size + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf8 <- glmer(nectarforaging ~ size + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf9 <- glmer(nectarforaging ~ ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf10 <- glmer(nectarforaging ~ ovSavg + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf11 <- glmer(nectarforaging ~ ovSavg + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf12 <- glmer(nectarforaging ~ size + ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf13 <- glmer(nectarforaging ~ size + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf14 <- glmer(nectarforaging ~ ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
nf17 <- glmer(nectarforaging ~ size  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf18 <- glmer(nectarforaging ~ ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf19 <- glmer(nectarforaging ~ ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf20 <- glmer(nectarforaging ~ ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf21 <- glmer(nectarforaging ~ ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf22 <- glmer(nectarforaging ~ ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf23 <- glmer(nectarforaging ~ ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf24 <- glmer(nectarforaging ~ size + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf25 <- glmer(nectarforaging ~ ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
nf26 <- glmer(nectarforaging ~ ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
gen0 <- glmer(generalist ~ 1 + (1|natal) + (1|nestID),
              data = count_wide, family = binomial)
gen1 <- glmer(generalist ~ size + ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen2 <- glmer(generalist ~ size + ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen3 <- glmer(generalist ~ size + ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen4 <- glmer(generalist ~ size + ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen5 <- glmer(generalist ~ size + ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen6 <- glmer(generalist ~ size + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen7 <- glmer(generalist ~ size + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen8 <- glmer(generalist ~ size + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen9 <- glmer(generalist ~ ovSavg + ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen10 <- glmer(generalist ~ ovSavg + ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen11 <- glmer(generalist ~ ovSavg + ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen12 <- glmer(generalist ~ size + ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen13 <- glmer(generalist ~ size + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen14 <- glmer(generalist ~ ovSavg + ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
...
gen17 <- glmer(generalist ~ size  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen18 <- glmer(generalist ~ ovSavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen19 <- glmer(generalist ~ ovSavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen20 <- glmer(generalist ~ ovSavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen21 <- glmer(generalist ~ ovRavg + queen + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen22 <- glmer(generalist ~ ovRavg + queen  + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen23 <- glmer(generalist ~ ovRavg  + nBees + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen24 <- glmer(generalist ~ size + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen25 <- glmer(generalist ~ ovSavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
gen26 <- glmer(generalist ~ ovRavg + (1|nestID) + (1|natal),
              data = count_wide, family = binomial)
