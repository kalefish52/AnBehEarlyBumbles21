...
s0 <- glmer(size ~ 1 + (1|natal:nestID) + (1|caste), data = FinalBehavRank)
s1 <- glmer(size ~ BehavAssign + (1|natal:nestID) + (BehavAssign|caste), data = FinalBehavRank)
...
s0 <- glmer(ovRavg ~ 1 + (1|natal:nestID) + (1|caste), data = FinalBehavRank)
s1 <- glmer(ovRavg ~ BehavAssign + (1|natal:nestID) + (BehavAssign|caste), data = FinalBehavRank)

model.sel(s0, s1)

#Ovary Stage 
hist(FinalBehavRank$ovSavg)
s0 <- glmer(ovSavg ~ 1 + (1|natal:nestID) + (1|caste), data = FinalBehavRank)
s1 <- glmer(ovSavg ~ BehavAssign + (1|natal:nestID) + (BehavAssign|caste), data = FinalBehavRank)
...
s0 <- glmer(size ~ 1 + (1|natal:nestID) + (1|caste), data = perfSpec)
s1 <- glmer(size ~ specBehav + (1|natal:nestID) + (specBehav|caste), data = perfSpec)

model.sel(s0, s1)

#Ovary Resporbtion 
hist(perfSpec$ovRavg)
s0 <- glmer(ovRavg ~ 1 + (1|natal:nestID) + (1|caste), data = perfSpec)
s1 <- glmer(ovRavg ~ specBehav + (1|natal:nestID) + (specBehav|caste), data = perfSpec)

model.sel(s0, s1)

#Ovary Stage 
hist(perfSpec$ovSavg)
s0 <- glmer(ovSavg ~ 1 + (1|natal:nestID) + (1|caste), data = perfSpec)
s1 <- glmer(ovSavg ~ specBehav + (1|natal:nestID) + (specBehav|caste), data = perfSpec)
