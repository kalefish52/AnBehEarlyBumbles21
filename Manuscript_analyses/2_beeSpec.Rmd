...
# and add number of workers
count_data$nWork <- NA
count_data[count_data$nestTYPE == "QF", "queen"] <- 5
count_data[count_data$nestTYPE == "QT", "queen"] <- 3
count_data[count_data$nestTYPE == "NF", "queen"] <- 5
count_data[count_data$nestTYPE == "NT", "queen"] <- 3
count_data
...
s4 <- glmer(avgRes ~ specBehav + nestTYPE + (1|nestID) + (1|natal),
              data = count_data)
s5 <- glmer(avgRes ~ size + queen + (1|nestID) + (1|natal),
              data = count_data)
