...
count_scaled <- count_scaled %>% select(!c(pf, el, fb, nf, nestnectar, nestpollen, nestegglaying, nestfeedsbrood, nestBehavs)) 
...
#remove nest total and scaling columns 
count_scaled <- count_scaled %>% select(!c(pf, fb, nf, nestnectar, nestpollen, nestfeedsbrood, nestBehavs)) 
