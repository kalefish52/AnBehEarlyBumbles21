...
sumNests <- count_data %>% group_by(nestID) %>% summarise(nectarforaging = sum(nectarforaging),
...
count_scaled$pollenforaging <- countScaled$pollenforaging / pf
count_scaled$egglaying <- countScaled$egglaying / el
count_scaled$feedsbrood <- countScaled$feedsbrood / fb
