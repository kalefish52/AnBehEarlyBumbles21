...
# print the number of bees that meet the shannon threshold
print(paste(nrow(count_data[!is.na(count_data$shannon),]), "known bees have over the threshold number of behaviors and will therefore be included in shannon analyses", sep = " "))
```
