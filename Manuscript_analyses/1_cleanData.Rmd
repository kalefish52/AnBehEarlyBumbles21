...
# count the number of bees that categorize as specialists
count_notNA <- count_data[!is.na(count_data$shannon),]
print(paste("there are", nrow(count_notNA[count_notNA$shannon <= shannonSpecialist, ]), "specialists", sep = " "))
nrow(count_data)
# save for future analyses
