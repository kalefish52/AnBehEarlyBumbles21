...
print(paste(nrow(count_time[!is.na(count_time$shanDist),]), "bees have over the threshold number of behaviors at both the early and late timepoints, and will therefore be included in shannon distance analyses", sep = " "))
