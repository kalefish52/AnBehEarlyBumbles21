...
# save list of bees for future analyses
write.csv(noObsBees, "../Data/filtData/noObsBees.csv")
write.csv(allBees, "../Data/filtData/allBees.csv")
```
...
# save count_data for future analyses
write.csv("../Data/filtData/count_data.csv")
```
...
# save this df for future analyses
...
totalLen_data <- videos_data %>%
  dplyr::select(obsID, nestID, nestTYPE, totalLen) %>%
  unique()
totalLen_data
...
totalLen_data <- totalLen_data %>%
  dplyr::select(camID, dateID, hourID, nestTYPE, nestID, totalLen)
...
##Save df to be used in future analyses 
...
# subset the df to remove the obs, hour, and date columns
timepoint_data <- totalLen_time %>%
  dplyr::select(camID, nestID, nestTYPE, totalLen)
# create empty dataframe to put length into
