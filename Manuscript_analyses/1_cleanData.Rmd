...
# knitr::opts_chunk$set(fig.width=3, fig.height=5) # use only to create multipanel shannon individual plot
...
ggarrange(p1, p2, nrow = 2, labels = c("A", "B"))
ggsave("../figures/taskShanPanel.jpg", height=6.5, width=4.5)
