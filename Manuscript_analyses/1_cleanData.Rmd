...
p1 <- ggplot(count_data, aes(shannon, fill = nestTYPE)) + 
  ...
  scale_fill_brewer(palette = "PuOr", labels = c("W3", "W5", "QW3", "QW5"))
p1

# plot nestTYPE vs. shannon scatterplot
p2 <- ggplot(count_data, aes(shannon, nestTYPE, color = nestTYPE, shape = caste)) +
  geom_point(position = position_jitter(width=0.02, height=0.2), alpha = 0.5) +
  scale_shape_manual(values = c(21, 16), labels = c("Queen", "Worker")) +
  scale_color_brewer(palette = "PuOr", labels = c("W3", "W5", "QW3", "QW5")) +
...
p3 <- ggplot(count_data, aes(shannon, nBehavs, color = nestTYPE, shape = caste)) +
  geom_point(position = position_jitter(width=0.02, height=3), alpha = 0.7, size = 2) +
  scale_shape_manual(values = c(21, 16), labels = c("Queen", "Worker")) +
  scale_color_brewer(palette = "PuOr", labels = c("W3", "W5", "QW3", "QW5")) +
...
p1 <- ggplot(taskShan, aes(shannon, behav)) +
  geom_point(position = position_jitter(width=0.05, height=0.2), alpha = 0.6, aes(shape = nestTYPE, color = behav)) +
  scale_shape_manual(values = c(16, 15, 21, 22), labels = c("W3", "W5", "QW3", "QW5")) +
  stat_summary(fun = mean, geom = "point", size = 4) +
  theme(axis.text.y=element_text(angle=90, vjust=0.5, hjust=0.5)) +
  labs(shape = "Social Configuration", color = "Task", x = "Task Shannon Diversity Index", y = "Task") +
...
p2 <- ggplot(taskShan, aes(shannon, nBehav, color = behav, shape = nestTYPE)) +
  geom_point(position = position_jitter(width=0.05, height=3), alpha = 0.8) +
  scale_shape_manual(values = c(16, 15, 21, 22), labels = c("W3", "W5", "QW3", "QW5")) +
