...
# 
# # sum columns for each behavior within each nest
# count_nestsEarlySums <- ddply(count_nestsEarly, 
#                 c("nestID"), 
#                 summarise,
#                 feedsbrood = sum(feedsbrood),
#                 egglaying = sum(egglaying),
...
#                 allforaging = sum(allforaging),
#                 nBehavs = sum(nBehavs))
# count_nestsEarlySums
# 
# # make df for proportions to be overwritten in loop:
# prop_nestsEarly <- count_nestsEarly
# 
# # for each bee, convert the count of behaviors to the proportion of observations of that behavior for that nest
# for (i in 1:nrow(count_nestsEarly)) {         # for each bee
#   for (j in 1:nrow(count_nestsEarlySums)) {       # go through the count_nestsEarlySums df
#     if (count_nestsEarly$nestID[i] == count_nestsEarlySums$nestID[j]) {   # until you find the matching nestID
#                                              # then divide the counts of each behavior by the total counts of that behavior in the nest
#       prop_nestsEarly$feedsbrood[i] <- count_nestsEarly$feedsbrood[i] / count_nestsEarlySums$feedsbrood[j]
#       prop_nestsEarly$egglaying[i] <- count_nestsEarly$egglaying[i] / count_nestsEarlySums$egglaying[j]
#       prop_nestsEarly$nectarforaging[i] <- count_nestsEarly$nectarforaging[i] / count_nestsEarlySums$nectarforaging[j]
#       prop_nestsEarly$pollenforaging[i] <- count_nestsEarly$pollenforaging[i] / count_nestsEarlySums$pollenforaging[j]
#       prop_nestsEarly$allforaging[i] <- count_nestsEarly$allforaging[i] / count_nestsEarlySums$allforaging[j]
#       prop_nestsEarly$nBehavs[i] <- count_nestsEarly$nBehavs[i] / count_nestsEarlySums$nBehavs[j]
#     }
#   }
# }
# prop_nestsEarly
# # write.csv(prop_nestsEarly, "../Data/filtData/prop_nestsEarly.csv")
# 
# # LATE
# 
# # sum columns for each behavior within each nest
# count_nestsLateSums <- ddply(count_nestsLate, 
#                 c("nestID"), 
#                 summarise,
#                 feedsbrood = sum(feedsbrood),
#                 egglaying = sum(egglaying),
...
# 
# # make df for proportions to be overwritten in loop:
# prop_nestsLate <- count_nestsLate
# 
# # for each bee, convert the count of behaviors to the proportion of observations of that behavior for that nest
# for (i in 1:nrow(count_nestsLate)) {         # for each bee
#   for (j in 1:nrow(count_nestsLateSums)) {       # go through the count_nestsLateSums df
#     if (count_nestsLate$nestID[i] == count_nestsLateSums$nestID[j]) {   # until you find the matching nestID
#                                              # then divide the counts of each behavior by the total counts of that behavior in the nest
#       prop_nestsLate$feedsbrood[i] <- count_nestsLate$feedsbrood[i] / count_nestsLateSums$feedsbrood[j]
#       prop_nestsLate$egglaying[i] <- count_nestsLate$egglaying[i] / count_nestsLateSums$egglaying[j]
#       prop_nestsLate$nectarforaging[i] <- count_nestsLate$nectarforaging[i] / count_nestsLateSums$nectarforaging[j]
#       prop_nestsLate$pollenforaging[i] <- count_nestsLate$pollenforaging[i] / count_nestsLateSums$pollenforaging[j]
#       prop_nestsLate$allforaging[i] <- count_nestsLate$allforaging[i] / count_nestsLateSums$allforaging[j]
#       prop_nestsLate$nBehavs[i] <- count_nestsLate$nBehavs[i] / count_nestsLateSums$nBehavs[j]
#     }
#   }
# }
# prop_nestsLate
# # write.csv(prop_nestsLate, "../Data/filtData/prop_nestsLate.csv")
```
