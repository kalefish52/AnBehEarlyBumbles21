...
```{r}
# remove lazy bees (have NA shannon values)
count_bees <- count_data %>% dplyr::filter(lazy=="notLazy") %>% dplyr::select(beeID) 
...
ps1 <- glmer(shan0 ~ timepoint + queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps2 <- glmer(shan0 ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps3 <- glmer(shan0 ~ timepoint + queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps4 <- glmer(shan0 ~ timepoint + queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps5 <- glmer(shan0 ~ timepoint + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps6 <- glmer(shan0 ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps7 <- glmer(shan0 ~ timepoint + queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps8 <- glmer(shan0 ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps9 <- glmer(shan0 ~ timepoint + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps10 <- glmer(shan0 ~ queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps11 <- glmer(shan0 ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps12 <- glmer(shan0 ~ queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps13 <- glmer(shan0 ~ nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps14 <- glmer(shan0 ~ queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps15 <- glmer(shan0 ~ nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = binomial(link = "logit"))
ps16 <- glmer(shan0 ~ caste + (1|nestID) + (1|natal),
...
ps0 <- glmer(shan1 ~ 1 + (1|nestID) + (1|natal),
              data = count_beesTime)
ps1 <- glmer(shan1 ~ timepoint + queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps2 <- glmer(shan1 ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps3 <- glmer(shan1 ~ timepoint + queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps4 <- glmer(shan1 ~ timepoint + queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime)
ps5 <- glmer(shan1 ~ timepoint + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps6 <- glmer(shan1 ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps7 <- glmer(shan1 ~ timepoint + queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime)
ps8 <- glmer(shan1 ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime)
ps9 <- glmer(shan1 ~ timepoint + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps10 <- glmer(shan1 ~ queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps11 <- glmer(shan1 ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime)
ps12 <- glmer(shan1 ~ queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime)
ps13 <- glmer(shan1 ~ nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime)
ps14 <- glmer(shan1 ~ queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime)
ps15 <- glmer(shan1 ~ nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime)
ps16 <- glmer(shan1 ~ caste + (1|nestID) + (1|natal),
...
ps1 <- glmer(shannon ~ timepoint + queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps2 <- glmer(shannon ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps3 <- glmer(shannon ~ timepoint + queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps4 <- glmer(shannon ~ timepoint + queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps5 <- glmer(shannon ~ timepoint + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps6 <- glmer(shannon ~ queen + nBees + nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps7 <- glmer(shannon ~ timepoint + queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps8 <- glmer(shannon ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps9 <- glmer(shannon ~ timepoint + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps10 <- glmer(shannon ~ queen + nBees + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps11 <- glmer(shannon ~ timepoint + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps12 <- glmer(shannon ~ queen + nBees + nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps13 <- glmer(shannon ~ nBehavs + caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps14 <- glmer(shannon ~ queen + nBees + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps15 <- glmer(shannon ~ nBehavs + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
ps16 <- glmer(shannon ~ caste + (1|nestID) + (1|natal),
              data = count_beesTime, family = gaussian(link = "identity"))
model.sel(ps0, ps1, ps2, ps3, ps4, ps5, ps6, ps7, ps8, ps9, ps10, ps11, ps12, ps13, ps14, ps15, ps16)
