...
# model 0 vs. >0 shannon values
ps1 <- glmer(shan0 ~ timepoint + nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time, family = binomial(link = "logit"))
ps4 <- glmer(shan0 ~ timepoint*nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time, family = binomial(link = "logit"))
ps2 <- glmer(shan0 ~ timepoint + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time, family = binomial(link = "logit"))
ps3 <- glmer(shan0 ~ nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time, family = binomial(link = "logit"))
ps0 <- glmer(shan0 ~ 1 + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time, family = binomial(link = "logit"))
...
ps1 <- glmer(shan1 ~ timepoint + nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time)
ps4 <- glmer(shan1 ~ timepoint*nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time)
ps2 <- glmer(shan1 ~ timepoint + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time)
ps3 <- glmer(shan1 ~ nestTYPE + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time)
ps0 <- glmer(shan1 ~ 1 + (1|nestID:beeID) + (1|natal) + (1|nBehavs),
              data = count_3Time)
